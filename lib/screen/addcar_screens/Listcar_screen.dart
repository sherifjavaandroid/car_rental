                          ...
                          child: Stack(
                            children: [
                              image.length == 1
                                ...
                                carouselController:
                                carouselController, // Correct controller here
                                        ...
                                        InkWell(
                                          onTap: () {
                                            ...
                                            edit(
                                                ...
                                                index]
                                                    .driverName,
                                                countryCode: myCarListModal!
                                                    .mycarlist[index]
                                                    .driverMobile
                                                    .toString()
                                                    .split(" ")
                                                    .first,
                                                mobile: myCarListModal!
                                                    .mycarlist[index]
                                                    .driverMobile
                                                    .toString()
                                                    .split(" ")
